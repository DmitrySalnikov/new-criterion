...
ress <- '/home/d/Study/publication2019/res/norm_5cauchy/mean/'
tables <- '/home/d/Study/publication2019/tables/norm_5cauchy/mean/'
...
# n=5 exact
{
  ...
  c1 <- c("$N5C(0, 1)$", '', '', '', '')
  c2 <- c("$N5C(0, 1)$", "$N5C(0.5, 1)$", "$N5C(1, 1)$", "$N5C(1.5, 1)$", "$N5C(2, 1)$")
  res <- round(res, 3)
  res <- cbind(c2, res)
  res <- cbind(c1, res)
  res
