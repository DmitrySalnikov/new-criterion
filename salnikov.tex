...
\begin{eqnarray}
  ...
  \label{CC2}
  CC_2^C &=& -\left( \frac{1}{n}\sum_{i=1}^n\left\{\ln\left(1+\left(\frac{|X_i-X_{cen}|}{X_{sd}}\right)^2\right) + \ln\left(1+\left(\frac{|Y_i-Y_{cen}|}{Y_{sd}}\right)^2\right)\right\} + \ln(X_{sd}) + \ln(Y_{sd}) \right),\\
  \label{CC3}
